...
<template>
  <div class="block sm:flex gap-0 sm:gap-10 mt-14">
    ...
    <div class="w-full sm:w-2/3 text-left mt-10 sm:mt-0">
      ...
      >
        <iframe src="https://docs.google.com/presentation/d/e/2PACX-1vTwroX4BgEKacPpVbFvCSciXKTFbxjgPSeLoKYFBQOXjooDAU4JgCD7qXY5yBOYAamTaDmAugO-RKJD/embed?start=false&loop=false&delayms=3000" frameborder="0" width="880" height="540" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
      </p>
      <!--			<p-->
