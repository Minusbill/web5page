...
<template>
  <div class="block sm:flex gap-0 sm:gap-10 mt-14">
    ...
    <div class="w-full sm:w-2/3 text-left mt-10 sm:mt-0">
      ...
      >
        <iframe src="https://docs.google.com/presentation/d/e/2PACX-1vSznvg9FH-wkjLqcb1TtveCFEkmHMHHG8jlwocV-sviGvIUG-I_8qV_tw-SEH3k6C2qWpsm_rYkalYP/embed?start=false&loop=false&delayms=3000" frameborder="0" width="880" height="565" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>      </p>
      <!--			<p-->
