...
const singleProjectHeader = {
  singleProjectTitle: 'Starknet.js 教程',
...
const projectInfo = {
  clientHeading: 'Starknet.js 教程',
  pptUrl:"https://docs.google.com/presentation/d/e/2PACX-1vSJ0Wp-iMMukZHcREutD56d9W_Bc3sY3eaqX5AdGbMl6w_PMopkjNLCd_Qa1a1wVY-2QmoQ0JdG1cId/embed?start=false&loop=false&delayms=3000",
  companyInfos: [
    { id: 1, title: '1 ', details: '命名空间' },
    { id: 2, title: '2', details: '枚举变量' },
    { id: 3, title: '3', details: '类' },
    { id: 3, title: '4', details: '接口方法' },
